...
export default function PendingHotelsScreen() {
  ...
  const loadPendingHotels = async () => {
    try {
      ...
      const result = await adminApi.getPendingHotel();
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        refreshing={loading}
        onRefresh={loadPendingHotels}
        ListEmptyComponent={
          <Text style={styles.emptyText}>Không có khách sạn nào chờ duyệt</Text>
        }
      />
    </View>
  );
