    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.section}>
          ...
          <View style={styles.infoSection}>
            <Text style={styles.infoLabel}>Giấy phép kinh doanh</Text>

            {host.businessLicenseUrls && host.businessLicenseUrls.length > 0 ? (
              <ScrollView
                horizontal
                  ...
                  return (
                    ...
                    >
                      <Image
                        ...
                        resizeMode="cover"
                        onError={() => {
                          console.log("LOAD LICENSE IMAGE FAILED:", imageUrl);
                        }}
                      />
              ...
              <Text style={styles.emptyText}>Chưa có giấy phép</Text>
            )}
          </View>
        </View>
      </ScrollView>
