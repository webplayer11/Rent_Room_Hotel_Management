    ...
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          ...
          <TouchableOpacity
            style={styles.row}
            onPress={() => router.push("/customer/(tabs)/wishlist")}
          >
            <Ionicons name="heart-outline" size={20} color="#FF4D6D" />
            <Text style={styles.rowText}>Danh sách yêu thích</Text>
            <Ionicons name="chevron-forward" size={18} color="#ccc" />
          </TouchableOpacity>
        </View>
        ...
        {/* HOST */}
        <View style={styles.card}>
          <Text style={styles.sectionTitle}>Kinh doanh</Text>

          <TouchableOpacity
            style={styles.row}
            onPress={() => router.push("/customer/setting/comehost")}
          >
            <Ionicons name="business-outline" size={20} color="#5392F9" />
            <Text style={styles.rowText}>Đăng ký trở thành Host</Text>
            <Ionicons name="chevron-forward" size={18} color="#ccc" />
          </TouchableOpacity>
        </View>
